...
import Module1.forms as forms
import Module1.models as models
...
app = Flask(__name__)
# api = Api(app)
app.secret_key = open('Module1/key.in','r').readline()
...
def run(host='127.0.0.1', port=8080, debug=True):
    models.initialize()
    try:
        models.User.create_user(
            username = 'anhnguyen',
            email = 'anhdnguyenn@gmail.com',
            password = 'password',
            admin = True
        )
    except ValueError:
